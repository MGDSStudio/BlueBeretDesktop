...
public class PlayerGreenadeAnimationController extends HumanAnimationController {
    public static final int SPRITE_FOR_GRENADE_ADDING = 3;
    ...
    public PlayerGreenadeAnimationController(Human soldier, boolean inBulletTimeMode) {
        super(soldier, Program.getAbsolutePathToAssetsFolder(PATH_TO_GRENADE_ANIMATION), inBulletTimeMode);
    }

    @Override
    protected void setUniqueAnimationData() {
        reloadAnimation.setLastSprite((int) 6);
        ...
        weaponAngleGraphicController.setWithAngleSpecificGraphic(false);
        spriteAnimation.setLastSprite((int) 4);
        idleAnimation.setLastSprite(8);
    ...
    public void startToReload() {
        System.out.println("Nothing to override for greenade");
    }
