...
public class OpenItemsListAnimation extends WithFrameAnimation {
    private static final int FRAME_WIDTH = UpperPanel.HEIGHT_FOR_WEAPON_FRAME;
    private static String PRESSING_TIME_TEXT = "PRESSING" + '\n' +"TIME: ";
    private static String FRAME_OPENED_TEXT = "INVENTORY" + '\n' + "OPENED!";


    public OpenItemsListAnimation(int x, int y, Rectangular controlZone, SoundInGameController soundInGameController) {
    ...
    protected void initGraphic() {
        ...
        inFrameImageData = InWorldObjectsGraphicData.mediumMedicalKitInBag;
