package com.mgdsstudio.blueberet.levelseditornew.sliders;

public enum LowLevelListSubbutons {
    NEW_MAP,
    OPEN_MAP,
    CLEAR_MAP,
    TEST_MAP,
    ...
    public static LowLevelListSubbutons getStatementByName(String name){
